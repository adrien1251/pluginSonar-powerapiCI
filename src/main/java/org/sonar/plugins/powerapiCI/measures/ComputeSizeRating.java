 ...
 */
package org.sonar.plugins.powerapiCI.measures;
...
public class ComputeSizeRating implements MeasureComputer {
  ...
  public MeasureComputerDefinition define(MeasureComputerDefinitionContext def) {
    return def.newDefinitionBuilder()
      .setInputMetrics(ExampleMetrics.FILENAME_SIZE.key())
      .setOutputMetrics(ExampleMetrics.FILENAME_SIZE_RATING.key())
      .build();
  }

  @Override
  public void compute(MeasureComputerContext context) {
    Measure size = context.getMeasure(ExampleMetrics.FILENAME_SIZE.key());
    if (size != null) {
      ...
      context.addMeasure(ExampleMetrics.FILENAME_SIZE_RATING.key(), rating);
    }
  }
}
